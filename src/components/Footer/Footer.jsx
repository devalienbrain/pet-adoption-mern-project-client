const Footer = () => {
  return (
    <footer className="pt-24">
      <div className="border-t grid grid-cols-1 md:grid-cols-4 p-10 container mx-auto">
      ...
      <div className="container mx-auto text-center flex justify-center text-xs py-9">
        <small>

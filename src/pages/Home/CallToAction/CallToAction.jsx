      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="flex-1 flex justify-center items-center p-5">
          <div className="text-left flex flex-col space-y-2">
            <h1 className="mb-5 text-xl md:text-3xl text-black font-bold">
              Unlocking Hearts and Changing Lives: The Pawsome Power of Pet
              Adoption!
            </h1>
            <p>
              When you adopt a pet, you're opening your heart to a furry friend
              who will reciprocate your love unconditionally. The bond formed is
              unlike any other, bringing joy and companionship to both your
              lives.
            </p>
            <p>
            ...
            <p>
              When you adopt, you become part of a community that values animal
              welfare. Shelters and rescue organizations often provide
              resources, support, and advice, creating a network of like-minded
              individuals who share a love for pets.
            </p>
            <p>
            ...
            <p>
              ...
              kindness but a transformative experience for both you and your new
              furry friend.
            </p>
          </div>
        </div>
